...
public class GoogleCustomOAuth2Authenticator extends OpenIDConnectAuthenticator {
    ...
    private void initTokenEndpoint() {
        this.tokenEndpoint = getAuthenticatorConfig().getParameterMap().get(GoogleCustomOAuth2AuthenticationConstant
    ...
    private void initOAuthEndpoint() {
        this.oAuthEndpoint = getAuthenticatorConfig().getParameterMap().get(GoogleCustomOAuth2AuthenticationConstant
    ...
    protected String getQueryString(Map<String, String> authenticatorProperties) {
        return authenticatorProperties.get(GoogleCustomOAuth2AuthenticationConstant.ADDITIONAL_QUERY_PARAMS);
    }
